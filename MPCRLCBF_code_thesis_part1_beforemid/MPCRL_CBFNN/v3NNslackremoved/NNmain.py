...
experiment_folder_name = "NNnoslack"
...
params = rl.rl_trainingloop(episode_duration = episode_duration, num_episodes = num_episodes, replay_buffer=replay_buffer, experiment_folder = experiment_folder_name)
...
generate_experiment_notes(experiment_folder_name, params, params_original, episode_duration, num_episodes, seed, alpha, dt, 
                          ...
                          stage_cost_sum_after, layers_list, replay_buffer)

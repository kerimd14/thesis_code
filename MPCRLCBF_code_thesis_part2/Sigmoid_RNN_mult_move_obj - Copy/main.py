...
def main():
    ...
    # RL hyper-parameters
    alpha = 5e-4      # initial learning rate
    gamma = 0.99      # discount factor
    slack_penalty_MPC_L1 = 4e5  # penalty on slack variables in CBF constraints for the MPC stage cost
    slack_penalty_MPC_L2 = 0#1e3
    slack_penalty_RL_L1 = 2e4 # penalty on slack variables in CBF constraints for RL stage cost
    ...
    experiment_folder = "RNN_mult_move_obj_experiment_21"

...
layers_list = [NUM_STATES+len(positions), 8, 8, len(positions)]
print("layers_list: ", layers_list)
#initializing the RNN
rnn_model = RNN(layers_list, positions, radii, horizon)

list, _, _, _ = rnn_model.initialize_parameters()

print(f"list: {list.shape}")

params_innit["rnn_params"] = list

#seems params_innit gets overwritten
params_original = params_innit.copy() 

experiment_folder_name = "RNNSigmoid_4"

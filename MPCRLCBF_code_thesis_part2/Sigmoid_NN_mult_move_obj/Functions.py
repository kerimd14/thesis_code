...
def run_simulation(params, env, experiment_folder, episode_duration, layers_list, after_updates, horizon, positions, radii, modes, mode_params):
    ...
    for i in range(episode_duration):
        ...
        action, _, alpha, g_resid, x_prev, lam_x_prev, lam_g_prev = MPC_func(state, mpc, params, solver_inst, xpred_list, ypred_list, x_prev, lam_x_prev, lam_g_prev)
...
def run_simulation_randomMPC(params, env, experiment_folder, episode_duration, layers_list, noise_scalingfactor, 
    ...
    for i in range(episode_duration):
        ...
        action, _, alpha,  x_prev, lam_x_prev, lam_g_prev = MPC_func_random(state, mpc, params, solver_inst, rand_noise, xpred_list, ypred_list, x_prev, lam_x_prev, lam_g_prev)
